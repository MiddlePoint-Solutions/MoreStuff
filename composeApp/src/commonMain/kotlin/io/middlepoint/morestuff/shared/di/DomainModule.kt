...
import io.middlepoint.morestuff.shared.domain.usecase.scope.GetScopesByNameUseCaseImpl
...
val scopeUseCases = module {
  ...
  factoryOf(::GetScopesByNameUseCaseImpl) bind GetScopesByNameUseCase::class
