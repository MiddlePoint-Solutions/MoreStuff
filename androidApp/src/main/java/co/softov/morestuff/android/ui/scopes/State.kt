...
sealed class ScopesUiEvent : BaseViewEvent {
    data class CreateScope(val uid: String, val name: String) : ScopesUiEvent()
    ...
    data class ReorderScope(val fromIndex: Int, val toIndex: Int, val isFinal: Boolean) : ScopesUiEvent()
}
