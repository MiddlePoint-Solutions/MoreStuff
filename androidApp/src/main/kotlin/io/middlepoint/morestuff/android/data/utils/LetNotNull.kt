...
inline fun <T1 : Any, T2 : Any, T3 : Any, T4 : Any, T5 : Any, R : Any> let5(
  p1: T1?,
  p2: T2?,
  p3: T3?,
  p4: T4?,
...
inline fun <T1 : Any, T2 : Any, T3 : Any, T4 : Any, T5 : Any, T6 : Any, R : Any> let6(
  p1: T1?,
  p2: T2?,
  p3: T3?,
  p4: T4?,
...
inline fun <T1 : Any, T2 : Any, T3 : Any, T4 : Any, T5 : Any, T6 : Any, T7 : Any, T8 : Any, R : Any> let8(
  p1: T1?,
  p2: T2?,
  p3: T3?,
  p4: T4?,
