package io.middlepoint.morestuff.android.domain.redux.state

import io.middlepoint.morestuff.android.domain.enums.AppSetting
import io.middlepoint.morestuff.android.domain.enums.AppSetting.DevSettings
import io.middlepoint.morestuff.android.domain.enums.AppSetting.FirstTime
import io.middlepoint.morestuff.android.domain.enums.AppSetting.ReviewTime
import io.middlepoint.morestuff.android.domain.enums.AppSetting.SnoozeLimit
import io.middlepoint.morestuff.android.domain.enums.AppSetting.Theme
...
import io.middlepoint.morestuff.android.domain.redux.state.SettingAction.InitSettings
import io.middlepoint.morestuff.android.domain.redux.state.SettingAction.OnBoardingComplete
import io.middlepoint.morestuff.android.domain.redux.state.SettingAction.SetAppTheme
import io.middlepoint.morestuff.android.domain.redux.state.SettingAction.SetSnoozeLimit
