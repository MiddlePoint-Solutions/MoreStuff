...
class GetTaskScheduleCountUseCaseImplTest {
    ...
    private val getTaskScheduleCountUseCaseImpl = GetTaskScheduleCountUseCaseImpl(scheduleRepository, timeManager)
    ...
    fun `returns count of task schedules`() = runBlocking {
        ...
        coEvery { scheduleRepository.countTodayTaskSchedules(taskId, timeRange.first, timeRange.second) } returns Either.Right(2)
        ...
        coVerify { scheduleRepository.countTodayTaskSchedules(taskId, timeRange.first, timeRange.second) }
    }
}
